#!/usr/bin/env python3
"""Launch EdgeTX Android build GUI without a console window."""
import os
import subprocess
import sys
...
def _show_error(message: str) -> None:
    try:
        ...
        ctypes.windll.user32.MessageBoxW(0, message[:2000], "EdgeTX Build GUI", 0x10)
    except Exception:
        pass
...
def main() -> int:
    os.chdir(APP_ROOT)
    rc = run_ps("ensure-gui-utf8.ps1")
    if rc != 0:
        return rc
    return run_ps("Build-EdgeTX-Gui.ps1")
