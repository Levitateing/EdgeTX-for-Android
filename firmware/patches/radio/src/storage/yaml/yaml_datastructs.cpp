...
// ANDROID platform storage must win even when PCBX10 is also defined
// for F429 pin compatibility (ANDROID_HW=TX16S).
#if defined(PCBANDROID)
 #include "yaml_datastructs_android.cpp"
