...
static const struct YamlNode struct_ModelData[] = {
  YAML_CUSTOM("semver",nullptr,w_semver),
  YAML_STRUCT("header", 1184, struct_ModelHeader, NULL),
...
//
// YAML ↔ C++ layout checks (keep in sync with yaml_parser.tmpl / yaml_data target)
//
static_assert(sizeof(ModelHeader) * 8 == 1184,
  "YAML/C++ size mismatch for ModelHeader; regenerate yaml_data");
static_assert(offsetof(ModelData, timers) == sizeof(ModelHeader),
  "ModelData layout mismatch after ModelHeader");
