...
// App (H750) ModelData layout uses 8 trim slots; keep MCU identical for sync.
#undef NUM_TRIMS
#define NUM_TRIMS 8
#endif
#include "gvars.h"
...
#if defined(RADIO_ANDROID) || defined(STM32H7)
  // Keep ModelData layout identical across App (H7) and MCU (F4) ANDROID builds.
