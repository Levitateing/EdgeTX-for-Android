...
// Fixed topbar zone count for Android storage layout (ModelData CHKSIZE 7659)
static constexpr int MAX_TOPBAR_ZONES = 7;
#elif defined(EDGE_TX_LCD_W)
// High-res SIMU: fixed zone count to preserve ModelData layout
static constexpr int MAX_TOPBAR_ZONES = 7;
#else
